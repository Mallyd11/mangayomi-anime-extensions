const mangayomiSources = [
  {
    ...
    "iconUrl":
      "https://www.google.com/s2/favicons?sz=256&domain=https://www.animeonsen.xyz",
    "typeSource": "single",
    "itemType": 1,
    "version": "1.0.5",
...
class DefaultExtension extends MProvider {
  ...
  async getToken() {
    ...
    var token_ts = parseInt(
      preferences.getString("animeosen_token_expiry_at", "0"),
    );
  ...
  async getVideoList(url) {
    ...
    var metaData = streamDetails.metadata;
    ...
    var subtitles = [];
    var subLinks = streamData.subtitles;
    var subLangs = metaData.subtitles;
    Object.keys(subLangs).forEach((lang) => {
      subtitles.push({
        label: lang,
        file: subLinks[lang],
      });
