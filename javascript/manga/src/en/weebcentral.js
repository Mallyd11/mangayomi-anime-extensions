const mangayomiSources = [
  {
    ...
    "apiUrl": "",
    "iconUrl":
      "https://www.google.com/s2/favicons?sz=128&domain=https://weebcentral.com",
    "typeSource": "single",
    "isManga": true,
    "itemType": 0,
    "hasCloudflare": true,
...
// Authors: - Swakshan, Schnitzel5, kodjodevf
...
class DefaultExtension extends MProvider {
  ...
  async getDetail(url) {
    ...
    var doc = await this.request(slug);
    var imageUrl = url.startsWith("http")
      ? this.getImageUrl(link)
    ...
    for (var chap of chapList) {
      var name = chap
        .selectFirst("span.grow.flex.items-center.gap-2")
        .selectFirst("span").text;
      var dateUpload = new Date(chap.selectFirst("time.text-datetime").text)
        .valueOf()
        .toString();
